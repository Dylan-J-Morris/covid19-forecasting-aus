...
def main(data_date, run_flag=0):
    """
    Runs the TP forecasting. The first part will just calculate the TP and the second part will 
    replace TP with an adjusted Reff when the caseloads are high. 
    """
    if run_flag in (0, 1):
