...
cdef class Forecast:
    ...
    cdef void initialise_sim(self, rng, np.int_t curr_time=0):
        """
    ...
    cdef inline void generate_new_cases(self, rng, np.int_t parent_key, np.float_t Reff, np.float_t k, travel=False):
        """
    ...
    cdef data_check(self, np.int_t day):
        """
